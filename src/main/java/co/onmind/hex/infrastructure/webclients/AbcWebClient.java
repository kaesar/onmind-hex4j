...
public class AbcWebClient {
    ...
    public AbcResponse sheet(String showColumns, String from, String some) {
    ...
    public AbcResponse find(AbcRequest request) {
    ...
    public AbcResponse insert(AbcRequest request) {
    ...
    public AbcResponse update(AbcRequest request) {
    ...
    public AbcResponse remove(AbcRequest request) {
    ...
    public AbcResponse create(AbcRequest request) {
    ...
    public AbcResponse drop(AbcRequest request) {
    ...
    public AbcResponse define(AbcRequest request) {
    ...
    public AbcResponse ask(AbcRequest request) {
