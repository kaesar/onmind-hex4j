package co.onmind.hex.transverse.exceptions;
...
import co.onmind.hex.infrastructure.controllers.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ScriptNotAllowedException.class)
    public ResponseEntity<ErrorResponse> handleScriptNotAllowed(
            ScriptNotAllowedException ex,
            HttpServletRequest request) {

        logger.warn("Script not allowed: {}", ex.getMessage());
